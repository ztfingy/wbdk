...
<script type="text/javascript">
	...
	{
	//注册可拖拽表格
	new DragedTable("colgtable");
	}
	
	$(document).ready(function(){                          
		//$("#colgtable").tablesorter().tablesorterPager({ container: $("#pagerOne"), size: 2, positionFixed: false }); 
		init();
		...
		$(".firstpage").click(function(){
			...
			$("#prodsfields").attr("action","showDashboardColGroup.php?page=1");
			$("#prodsfields").submit();
			}
		});
		...
		$(".prevpage").click(function(){
			...
			$("#prodsfields").attr("action","showDashboardColGroup.php?page="+prevpage);
			$("#prodsfields").submit();
			}
		});
		...
		$(".nextpage").click(function(){
			...
			var totalpage = $("#totalpageid").html();
			var pagesize = $("#pagessizeid").val();
			$("#prodsfields").attr("action","showDashboardColGroup.php?page="+nextpage);
			$("#prodsfields").submit();
		});
		...
		$(".lastpage").click(function(){
			...
			var totalpage = $("#totalpageid").html();
			var pagesize = $("#pagessizeid").val();
			$("#prodsfields").attr("action","showDashboardColGroup.php?page="+totalpage);
			$("#prodsfields").submit();
		});
	});
...
<table width="100%" border="2" align="center" cellpadding="2" cellspacing="0" bordercolor="#00468C" id="colgtable">
<thead>
</thead>
 <tbody>
 <?php 
	...
	if ($totalgroupfield<=0) {
		...
		while ($rowgroupfield = mysql_fetch_array($resultgroupfield)) {
			//echo "<input type='button' value='".$rowgroupfield['valueProd']."' class='groupbutton' />";
			$grouptitle = "";
...
<td colspan="4"  style="background-image:url('images/webdocker_over_71.png'); background-repeat:no-repeat; background-position:3px center;background-color:#38557D; color:#FFFFFF; padding-left:20px;">
<?php 
echo $grouptitle;
?>
</td></tr>
  <tr valign="top" class="<?php echo str_replace(" ","_",$grouptitle)."item";?>">
<?php 
	...
	<?php 
		$o++;
		if ($o==4) {
			echo "</tr><tr class='".str_replace(" ","_",$grouptitle)."item'>";
			$o=0;
		}
		}}
